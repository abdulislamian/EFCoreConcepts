...
namespace EFCore_DataAccess.Migrations
{
    ...
    [Migration("20231012020219_addManytoMany_WithMappingTable")]
    partial class addManytoMany_WithMappingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore_Models.Models.Fulent_BookAuthorMap", b =>
                {
                    b.Property<int>("AuthorId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Fulent_BookAuthorMap");
                });
            ...
            modelBuilder.Entity("EFCore_Models.Models.Fulent_BookAuthorMap", b =>
                {
                    b.HasOne("EFCore_Models.Models.Fulent_Authors", "Authors")
                        .WithMany("BookAuthorMap")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
